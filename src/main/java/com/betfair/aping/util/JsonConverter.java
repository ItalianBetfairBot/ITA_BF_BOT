...
public class JsonConverter {
     ...
     * Just formatting the string to the ISO format does not adjust by the timezone
     * on the Date instance during serialization.
     */
     ...
     *
     */
    public synchronized static <T> T convertFromJson(String toConvert, Class<T> clazz) {
        if (toConvert.equals(""))
        return null;
    else
     ...
     *
     */
    public synchronized static <T> T convertFromJson(String toConvert, Type typeOfT) {
        if (toConvert.equals(""))
            return null;
        else
     ...
     * representation.
     */
    public synchronized static String convertToJson(Object toConvert) {
