...
public class V3Fixtures {
    ...
    public V3Fixtures withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3Fixtures withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3Fixtures withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3Fixtures withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3Fixtures withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3Fixtures withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3Fixtures withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3Fixtures.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3Fixtures) == false) {
            return false;
        }
        V3Fixtures rhs = ((V3Fixtures) other);
