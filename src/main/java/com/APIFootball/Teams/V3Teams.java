...
public class V3Teams {
    ...
    public V3Teams withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3Teams withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3Teams withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3Teams withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3Teams withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3Teams withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3Teams withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3Teams.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3Teams) == false) {
            return false;
        }
        V3Teams rhs = ((V3Teams) other);
