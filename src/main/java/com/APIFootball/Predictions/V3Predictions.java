...
public class V3Predictions {
    ...
    public V3Predictions withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3Predictions withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3Predictions withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3Predictions withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3Predictions withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3Predictions withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3Predictions withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3Predictions.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3Predictions) == false) {
            return false;
        }
        V3Predictions rhs = ((V3Predictions) other);
