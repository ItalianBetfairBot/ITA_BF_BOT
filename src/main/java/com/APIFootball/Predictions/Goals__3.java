...
public class Goals__3 {

    @JsonProperty("for")
    private For__2 _for;
    @JsonProperty("against")
    private Against__2 against;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("for")
    public For__2 getFor() {
        return _for;
    }

    @JsonProperty("for")
    public void setFor(For__2 _for) {
        this._for = _for;
    }

    public Goals__3 withFor(For__2 _for) {
        this._for = _for;
        return this;
    }

    @JsonProperty("against")
    public Against__2 getAgainst() {
        return against;
    }

    @JsonProperty("against")
    public void setAgainst(Against__2 against) {
        this.against = against;
    }

    public Goals__3 withAgainst(Against__2 against) {
        this.against = against;
        return this;
    }
    ...
    public Goals__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Goals__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("_for");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Goals__3) == false) {
            return false;
        }
        Goals__3 rhs = ((Goals__3) other);
