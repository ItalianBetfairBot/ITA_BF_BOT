...
public class For__1 {
    ...
    public For__1 withTotal(Total total) {
        this.total = total;
        return this;
    }
    ...
    public For__1 withAverage(Average average) {
        this.average = average;
        return this;
    }
    ...
    public For__1 withMinute(Minute minute) {
        this.minute = minute;
        return this;
    }
    ...
    public For__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(For__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof For__1) == false) {
            return false;
        }
        For__1 rhs = ((For__1) other);
