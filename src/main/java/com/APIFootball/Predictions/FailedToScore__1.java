...
public class FailedToScore__1 {
    ...
    public FailedToScore__1 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public FailedToScore__1 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public FailedToScore__1 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public FailedToScore__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(FailedToScore__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FailedToScore__1) == false) {
            return false;
        }
        FailedToScore__1 rhs = ((FailedToScore__1) other);
