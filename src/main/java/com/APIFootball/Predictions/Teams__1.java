...
public class Teams__1 {

    @JsonProperty("home")
    private Home__1 home;
    @JsonProperty("away")
    private Away__1 away;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("home")
    public Home__1 getHome() {
        return home;
    }

    @JsonProperty("home")
    public void setHome(Home__1 home) {
        this.home = home;
    }

    public Teams__1 withHome(Home__1 home) {
        this.home = home;
        return this;
    }

    @JsonProperty("away")
    public Away__1 getAway() {
        return away;
    }

    @JsonProperty("away")
    public void setAway(Away__1 away) {
        this.away = away;
    }

    public Teams__1 withAway(Away__1 away) {
        this.away = away;
        return this;
    }
    ...
    public Teams__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Teams__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Teams__1) == false) {
            return false;
        }
        Teams__1 rhs = ((Teams__1) other);
