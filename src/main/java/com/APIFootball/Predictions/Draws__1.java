...
public class Draws__1 {
    ...
    public Draws__1 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Draws__1 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Draws__1 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Draws__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Draws__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Draws__1) == false) {
            return false;
        }
        Draws__1 rhs = ((Draws__1) other);
