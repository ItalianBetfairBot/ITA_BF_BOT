...
public class Att {
    ...
    public Att withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Att withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Att withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Att.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
