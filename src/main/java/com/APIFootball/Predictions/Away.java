...
public class Away {
    ...
    private String logo;
    @JsonProperty("last_5")
    private Last5__1 last5;
    @JsonProperty("league")
    private League__2 league;
    @JsonIgnore
    ...
    public Away withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Away withLogo(String logo) {
        this.logo = logo;
        return this;
    }

    @JsonProperty("last_5")
    public Last5__1 getLast5() {
        return last5;
    }

    @JsonProperty("last_5")
    public void setLast5(Last5__1 last5) {
        this.last5 = last5;
    }

    public Away withLast5(Last5__1 last5) {
        this.last5 = last5;
        return this;
    }

    @JsonProperty("league")
    public League__2 getLeague() {
        return league;
    }

    @JsonProperty("league")
    public void setLeague(League__2 league) {
        this.league = league;
    }

    public Away withLeague(League__2 league) {
        this.league = league;
        return this;
    }
    ...
    public Away withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Away.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
