...
public class Total__2 {
    ...
    public Total__2 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Total__2 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Total__2 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Total__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Total__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Total__2) == false) {
            return false;
        }
        Total__2 rhs = ((Total__2) other);
