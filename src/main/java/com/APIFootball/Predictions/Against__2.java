...
public class Against__2 {
    ...
    public Against__2 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Against__2 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Against__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Against__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Against__2) == false) {
            return false;
        }
        Against__2 rhs = ((Against__2) other);
