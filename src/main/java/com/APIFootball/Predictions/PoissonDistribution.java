...
public class PoissonDistribution {
    ...
    public PoissonDistribution withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public PoissonDistribution withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public PoissonDistribution withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(PoissonDistribution.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PoissonDistribution) == false) {
            return false;
        }
        PoissonDistribution rhs = ((PoissonDistribution) other);
