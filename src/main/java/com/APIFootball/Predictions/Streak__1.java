...
public class Streak__1 {
    ...
    public Streak__1 withWins(Integer wins) {
        this.wins = wins;
        return this;
    }
    ...
    public Streak__1 withDraws(Integer draws) {
        this.draws = draws;
        return this;
    }
    ...
    public Streak__1 withLoses(Integer loses) {
        this.loses = loses;
        return this;
    }
    ...
    public Streak__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Streak__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("wins");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Streak__1) == false) {
            return false;
        }
        Streak__1 rhs = ((Streak__1) other);
