...
public class Missed {
    ...
    public Missed withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Missed withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public Missed withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Missed.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Missed) == false) {
            return false;
        }
        Missed rhs = ((Missed) other);
