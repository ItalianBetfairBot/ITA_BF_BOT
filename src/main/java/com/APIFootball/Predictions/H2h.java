...
public class H2h {
    ...
    public H2h withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public H2h withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public H2h withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(H2h.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
