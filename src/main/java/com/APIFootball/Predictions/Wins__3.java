...
public class Wins__3 {
    ...
    public Wins__3 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Wins__3 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Wins__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wins__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wins__3) == false) {
            return false;
        }
        Wins__3 rhs = ((Wins__3) other);
