...
public class Total__3 {
    ...
    public Total__3 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Total__3 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Total__3 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Total__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Total__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Total__3) == false) {
            return false;
        }
        Total__3 rhs = ((Total__3) other);
