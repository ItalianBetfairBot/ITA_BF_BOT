...
public class Against__3 {
    ...
    public Against__3 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Against__3 withAverage(String average) {
        this.average = average;
        return this;
    }
    ...
    public Against__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Against__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Against__3) == false) {
            return false;
        }
        Against__3 rhs = ((Against__3) other);
