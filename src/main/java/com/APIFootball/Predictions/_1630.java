...
public class _1630 {
    ...
    public _1630 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public _1630 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public _1630 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_1630 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _1630) == false) {
            return false;
        }
        _1630 rhs = ((_1630) other);
