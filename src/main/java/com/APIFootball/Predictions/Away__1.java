...
public class Away__1 {
    ...
    public Away__1 withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Away__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Away__1 withLogo(String logo) {
        this.logo = logo;
        return this;
    }
    ...
    public Away__1 withWinner(Boolean winner) {
        this.winner = winner;
        return this;
    }
    ...
    public Away__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Away__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Away__1) == false) {
            return false;
        }
        Away__1 rhs = ((Away__1) other);
