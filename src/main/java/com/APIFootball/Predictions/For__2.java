...
public class For__2 {
    ...
    public For__2 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public For__2 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public For__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(For__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof For__2) == false) {
            return false;
        }
        For__2 rhs = ((For__2) other);
