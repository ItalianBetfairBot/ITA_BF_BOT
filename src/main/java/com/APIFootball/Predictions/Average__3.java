...
public class Average__3 {
    ...
    public Average__3 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Average__3 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Average__3 withTotal(String total) {
        this.total = total;
        return this;
    }
    ...
    public Average__3 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Average__3 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Average__3) == false) {
            return false;
        }
        Average__3 rhs = ((Average__3) other);
