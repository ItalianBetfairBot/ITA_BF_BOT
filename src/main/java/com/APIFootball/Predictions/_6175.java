...
public class _6175 {
    ...
    public _6175 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public _6175 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public _6175 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_6175 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _6175) == false) {
            return false;
        }
        _6175 rhs = ((_6175) other);
