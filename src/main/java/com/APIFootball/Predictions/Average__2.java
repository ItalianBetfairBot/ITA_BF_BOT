...
public class Average__2 {
    ...
    public Average__2 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Average__2 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Average__2 withTotal(String total) {
        this.total = total;
        return this;
    }
    ...
    public Average__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Average__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Average__2) == false) {
            return false;
        }
        Average__2 rhs = ((Average__2) other);
