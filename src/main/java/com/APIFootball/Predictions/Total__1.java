...
public class Total__1 {
    ...
    public Total__1 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Total__1 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Total__1 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Total__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Total__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Total__1) == false) {
            return false;
        }
        Total__1 rhs = ((Total__1) other);
