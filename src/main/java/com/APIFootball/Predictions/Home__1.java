...
public class Home__1 {
    ...
    public Home__1 withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Home__1 withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Home__1 withLogo(String logo) {
        this.logo = logo;
        return this;
    }
    ...
    public Home__1 withWinner(Boolean winner) {
        this.winner = winner;
        return this;
    }
    ...
    public Home__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Home__1) == false) {
            return false;
        }
        Home__1 rhs = ((Home__1) other);
