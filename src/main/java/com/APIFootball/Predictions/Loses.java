...
public class Loses {
    ...
    public Loses withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Loses withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Loses withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Loses withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Loses.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Loses) == false) {
            return false;
        }
        Loses rhs = ((Loses) other);
