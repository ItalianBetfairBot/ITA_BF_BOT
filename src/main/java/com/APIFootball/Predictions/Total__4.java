...
public class Total__4 {
    ...
    public Total__4 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Total__4 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Total__4 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Total__4 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Total__4) == false) {
            return false;
        }
        Total__4 rhs = ((Total__4) other);
