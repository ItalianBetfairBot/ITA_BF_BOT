...
public class Goals__8 {
    ...
    public Goals__8 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Goals__8 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Goals__8 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Goals__8 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Goals__8) == false) {
            return false;
        }
        Goals__8 rhs = ((Goals__8) other);
