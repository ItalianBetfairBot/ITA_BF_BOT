...
public class Def {
    ...
    public Def withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Def withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Def withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Def.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
