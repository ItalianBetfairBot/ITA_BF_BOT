...
public class Goals__6 {

    @JsonProperty("for")
    private For__5 _for;
    @JsonProperty("against")
    private Against__5 against;
    @JsonIgnore
    private Map<String, Object> additionalProperties = new HashMap<String, Object>();

    @JsonProperty("for")
    public For__5 getFor() {
        return _for;
    }

    @JsonProperty("for")
    public void setFor(For__5 _for) {
        this._for = _for;
    }

    public Goals__6 withFor(For__5 _for) {
        this._for = _for;
        return this;
    }

    @JsonProperty("against")
    public Against__5 getAgainst() {
        return against;
    }

    @JsonProperty("against")
    public void setAgainst(Against__5 against) {
        this.against = against;
    }

    public Goals__6 withAgainst(Against__5 against) {
        this.against = against;
        return this;
    }
    ...
    public Goals__6 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Goals__6 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("_for");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Goals__6) == false) {
            return false;
        }
        Goals__6 rhs = ((Goals__6) other);
