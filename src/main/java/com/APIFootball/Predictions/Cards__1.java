...
public class Cards__1 {
    ...
    @JsonProperty("yellow")
    public Yellow__1 getYellow() {
        return yellow;
    }

    @JsonProperty("yellow")
    public void setYellow(Yellow__1 yellow) {
        this.yellow = yellow;
    }

    public Cards__1 withYellow(Yellow__1 yellow) {
        this.yellow = yellow;
        return this;
    }

    @JsonProperty("red")
    public Red__1 getRed() {
        return red;
    }

    @JsonProperty("red")
    public void setRed(Red__1 red) {
        this.red = red;
    }

    public Cards__1 withRed(Red__1 red) {
        this.red = red;
        return this;
    }
    ...
    public Cards__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
