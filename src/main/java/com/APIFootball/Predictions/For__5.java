...
public class For__5 {
    ...
    public For__5 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public For__5 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public For__5 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(For__5 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof For__5) == false) {
            return false;
        }
        For__5 rhs = ((For__5) other);
