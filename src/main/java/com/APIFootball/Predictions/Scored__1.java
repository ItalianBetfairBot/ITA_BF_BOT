...
public class Scored__1 {
    ...
    public Scored__1 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Scored__1 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public Scored__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scored__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scored__1) == false) {
            return false;
        }
        Scored__1 rhs = ((Scored__1) other);
