...
public class H2h__1 {
    ...
    @JsonProperty("league")
    private League__3 league;
    @JsonProperty("teams")
    private Teams__1 teams;
    @JsonProperty("goals")
    private Goals__8 goals;
    @JsonProperty("score")
    private Score score;
    @JsonIgnore
    ...
    public H2h__1 withFixture(Fixture fixture) {
        this.fixture = fixture;
        return this;
    }

    @JsonProperty("league")
    public League__3 getLeague() {
        return league;
    }

    @JsonProperty("league")
    public void setLeague(League__3 league) {
        this.league = league;
    }

    public H2h__1 withLeague(League__3 league) {
        this.league = league;
        return this;
    }

    @JsonProperty("teams")
    public Teams__1 getTeams() {
        return teams;
    }

    @JsonProperty("teams")
    public void setTeams(Teams__1 teams) {
        this.teams = teams;
    }

    public H2h__1 withTeams(Teams__1 teams) {
        this.teams = teams;
        return this;
    }

    @JsonProperty("goals")
    public Goals__8 getGoals() {
        return goals;
    }

    @JsonProperty("goals")
    public void setGoals(Goals__8 goals) {
        this.goals = goals;
    }

    public H2h__1 withGoals(Goals__8 goals) {
        this.goals = goals;
        return this;
    }
    ...
    public H2h__1 withScore(Score score) {
        this.score = score;
        return this;
    }
    ...
    public H2h__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(H2h__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("fixture");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof H2h__1) == false) {
            return false;
        }
        H2h__1 rhs = ((H2h__1) other);
