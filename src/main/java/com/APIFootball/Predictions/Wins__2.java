...
public class Wins__2 {
    ...
    public Wins__2 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Wins__2 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Wins__2 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Wins__2 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wins__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wins__2) == false) {
            return false;
        }
        Wins__2 rhs = ((Wins__2) other);
