...
public class CleanSheet__1 {
    ...
    public CleanSheet__1 withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public CleanSheet__1 withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public CleanSheet__1 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public CleanSheet__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CleanSheet__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CleanSheet__1) == false) {
            return false;
        }
        CleanSheet__1 rhs = ((CleanSheet__1) other);
