...
public class Goals__7 {
    ...
    public Goals__7 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Goals__7 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Goals__7 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Goals__7 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Goals__7) == false) {
            return false;
        }
        Goals__7 rhs = ((Goals__7) other);
