...
public class V3Events {
    ...
    public V3Events withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3Events withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3Events withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3Events withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3Events withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3Events withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3Events withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3Events.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3Events) == false) {
            return false;
        }
        V3Events rhs = ((V3Events) other);
