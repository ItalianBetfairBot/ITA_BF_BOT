...
public class Halftime {
    ...
    public Halftime withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Halftime withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Halftime withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Halftime.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Halftime) == false) {
            return false;
        }
        Halftime rhs = ((Halftime) other);
