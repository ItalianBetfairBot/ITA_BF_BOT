...
package com.APIFootball.V3TeamFixture;
...
public class V3TeamFixture {
    ...
    public V3TeamFixture withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3TeamFixture withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3TeamFixture withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3TeamFixture withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3TeamFixture withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3TeamFixture withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3TeamFixture withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3TeamFixture.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3TeamFixture) == false) {
            return false;
        }
        V3TeamFixture rhs = ((V3TeamFixture) other);
