...
public class Extratime {
    ...
    public Extratime withHome(Object home) {
        this.home = home;
        return this;
    }
    ...
    public Extratime withAway(Object away) {
        this.away = away;
        return this;
    }
    ...
    public Extratime withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Extratime.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Extratime) == false) {
            return false;
        }
        Extratime rhs = ((Extratime) other);
