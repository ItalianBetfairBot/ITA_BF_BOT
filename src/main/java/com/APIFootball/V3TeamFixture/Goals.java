...
public class Goals {
    ...
    public Goals withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Goals withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Goals withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Goals.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Goals) == false) {
            return false;
        }
        Goals rhs = ((Goals) other);
