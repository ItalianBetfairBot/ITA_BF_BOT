...
public class Played {
    ...
    public Played withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Played withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Played withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Played withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Played.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Played) == false) {
            return false;
        }
        Played rhs = ((Played) other);
