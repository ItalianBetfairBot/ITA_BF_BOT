...
public class CleanSheet {
    ...
    public CleanSheet withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public CleanSheet withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public CleanSheet withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public CleanSheet withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(CleanSheet.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CleanSheet) == false) {
            return false;
        }
        CleanSheet rhs = ((CleanSheet) other);
