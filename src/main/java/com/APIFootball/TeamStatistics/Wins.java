...
public class Wins {
    ...
    public Wins withHome(Integer home) {
        this.home = home;
        return this;
    }
    ...
    public Wins withAway(Integer away) {
        this.away = away;
        return this;
    }
    ...
    public Wins withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Wins withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wins.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wins) == false) {
            return false;
        }
        Wins rhs = ((Wins) other);
