...
public class _4660 {
    ...
    public _4660 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public _4660 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public _4660 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_4660 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _4660) == false) {
            return false;
        }
        _4660 rhs = ((_4660) other);
