...
public class _3145 {
    ...
    public _3145 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public _3145 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public _3145 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_3145 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _3145) == false) {
            return false;
        }
        _3145 rhs = ((_3145) other);
