...
public class V3TeamStatistics {
    ...
    public V3TeamStatistics withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3TeamStatistics withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3TeamStatistics withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3TeamStatistics withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3TeamStatistics withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3TeamStatistics withResponse(Response response) {
        this.response = response;
        return this;
    }
    ...
    public V3TeamStatistics withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3TeamStatistics.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3TeamStatistics) == false) {
            return false;
        }
        V3TeamStatistics rhs = ((V3TeamStatistics) other);
