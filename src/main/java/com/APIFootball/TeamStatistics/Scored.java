...
public class Scored {
    ...
    public Scored withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public Scored withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public Scored withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Scored.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Scored) == false) {
            return false;
        }
        Scored rhs = ((Scored) other);
