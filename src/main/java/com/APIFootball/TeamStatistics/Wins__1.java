...
public class Wins__1 {
    ...
    public Wins__1 withHome(String home) {
        this.home = home;
        return this;
    }
    ...
    public Wins__1 withAway(String away) {
        this.away = away;
        return this;
    }
    ...
    public Wins__1 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Wins__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("home");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Wins__1) == false) {
            return false;
        }
        Wins__1 rhs = ((Wins__1) other);
