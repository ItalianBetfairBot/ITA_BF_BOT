...
public class Against {
    ...
    public Against withTotal(Total__1 total) {
        this.total = total;
        return this;
    }
    ...
    public Against withAverage(Average__1 average) {
        this.average = average;
        return this;
    }
    ...
    public Against withMinute(Minute__1 minute) {
        this.minute = minute;
        return this;
    }
    ...
    public Against withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Against.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Against) == false) {
            return false;
        }
        Against rhs = ((Against) other);
