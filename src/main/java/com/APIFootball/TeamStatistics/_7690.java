...
public class _7690 {
    ...
    public _7690 withTotal(Integer total) {
        this.total = total;
        return this;
    }
    ...
    public _7690 withPercentage(String percentage) {
        this.percentage = percentage;
        return this;
    }
    ...
    public _7690 withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(_7690 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("total");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof _7690) == false) {
            return false;
        }
        _7690 rhs = ((_7690) other);
