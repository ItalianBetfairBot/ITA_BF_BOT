...
public class League {
    ...
    private List<List<Standing>> standings = new ArrayList<List<Standing>>();
    @JsonIgnore
    ...
    public League withStandings(List<List<Standing>> standings) {
        this.standings = standings;
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (((((((((this.country == rhs.country)||((this.country!= null)&&this.country.equals(rhs.country)))&&((this.flag == rhs.flag)||((this.flag!= null)&&this.flag.equals(rhs.flag))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.logo == rhs.logo)||((this.logo!= null)&&this.logo.equals(rhs.logo))))&&((this.season == rhs.season)||((this.season!= null)&&this.season.equals(rhs.season))))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.standings == rhs.standings)||((this.standings!= null)&&this.standings.equals(rhs.standings))));
    }
