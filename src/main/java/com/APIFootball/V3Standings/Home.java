...
public class Home {
    ...
    public Home withPlayed(Integer played) {
        this.played = played;
        return this;
    }
    ...
    public Home withWin(Integer win) {
        this.win = win;
        return this;
    }
    ...
    public Home withDraw(Integer draw) {
        this.draw = draw;
        return this;
    }
    ...
    public Home withLose(Integer lose) {
        this.lose = lose;
        return this;
    }
    ...
    public Home withGoals(Goals__1 goals) {
        this.goals = goals;
        return this;
    }
