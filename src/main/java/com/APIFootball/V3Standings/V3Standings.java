...
public class V3Standings {
    ...
    public V3Standings withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3Standings withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3Standings withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3Standings withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3Standings withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3Standings withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3Standings withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3Standings.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3Standings) == false) {
            return false;
        }
        V3Standings rhs = ((V3Standings) other);
