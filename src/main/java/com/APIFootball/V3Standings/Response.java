...
public class Response {
    ...
    public boolean equals(Object other) {
        ...
        return (((this.league == rhs.league)||((this.league!= null)&&this.league.equals(rhs.league)))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))));
    }
