...
public class V3League {
    ...
    public V3League withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3League withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3League withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3League withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3League withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3League withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3League withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3League.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3League) == false) {
            return false;
        }
        V3League rhs = ((V3League) other);
