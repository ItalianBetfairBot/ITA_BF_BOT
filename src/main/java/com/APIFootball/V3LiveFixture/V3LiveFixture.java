...
public class V3LiveFixture {
    ...
    public V3LiveFixture withGet(String get) {
        this.get = get;
        return this;
    }
    ...
    public V3LiveFixture withParameters(Parameters parameters) {
        this.parameters = parameters;
        return this;
    }
    ...
    public V3LiveFixture withErrors(List<Object> errors) {
        this.errors = errors;
        return this;
    }
    ...
    public V3LiveFixture withResults(Integer results) {
        this.results = results;
        return this;
    }
    ...
    public V3LiveFixture withPaging(Paging paging) {
        this.paging = paging;
        return this;
    }
    ...
    public V3LiveFixture withResponse(List<Response> response) {
        this.response = response;
        return this;
    }
    ...
    public V3LiveFixture withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(V3LiveFixture.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("get");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof V3LiveFixture) == false) {
            return false;
        }
        V3LiveFixture rhs = ((V3LiveFixture) other);
