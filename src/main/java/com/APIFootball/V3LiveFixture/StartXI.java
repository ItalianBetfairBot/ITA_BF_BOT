...
public class StartXI {
    ...
    public StartXI withPlayer(Player__1 player) {
        this.player = player;
        return this;
    }
    ...
    public StartXI withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(StartXI.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("player");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StartXI) == false) {
            return false;
        }
        StartXI rhs = ((StartXI) other);
