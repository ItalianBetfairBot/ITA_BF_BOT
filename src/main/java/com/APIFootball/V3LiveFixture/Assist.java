...
public class Assist {
    ...
    public Assist withId(Integer id) {
        this.id = id;
        return this;
    }
    ...
    public Assist withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public Assist withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(Assist.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
